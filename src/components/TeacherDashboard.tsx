...
import { LogOut, Plus, Filter, BarChart3, FileText, Menu, X } from 'lucide-react';
...
type TabType = 'estatisticas' | 'ocorrencias';
...
export function TeacherDashboard({ 
  ...
  // Filtra ocorrências registradas pelo professor
  const myOccurrences = occurrences.filter(o => o.professorId === user.id);
  
  const filteredOccurrences = filterCategory === 'todas' 
    ? myOccurrences 
    : myOccurrences.filter(o => o.categoria === filterCategory);
        ...
        <div className="px-4 py-3">
          <div className="flex justify-between items-center">
            <div className="flex-1 min-w-0">
              <h1 className="text-white text-lg truncate">Professor</h1>
              <p className="text-green-50 text-xs truncate mt-0.5">{user.nome}</p>
            </div>
            <button
      ...
      <div className="flex-1 overflow-y-auto pb-20">
        <div className="p-4 space-y-4">
          ...
          {activeTab === 'estatisticas' && (
            <>
              <div className="flex justify-between items-center">
                <h2 className="text-gray-900 text-base">Minhas Estatísticas</h2>
                <button
              ...
              <div className="bg-purple-50 border-2 border-purple-400 rounded-xl p-4">
                ...
                <p className="text-purple-900 text-3xl mt-2">
                  {myOccurrences.filter(o => o.categoria === 'gravissima').length}
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                {myOccurrences.length === 0 ? (
                  <div className="bg-white rounded-xl shadow-md p-6 text-center">
                    <p className="text-gray-500 text-sm">Nenhuma ocorrência registrada ainda</p>
                  </div>
                ) : (
          ...
          {activeTab === 'ocorrencias' && (
            <>
              <div className="flex justify-between items-center">
                <h2 className="text-gray-900 text-base">Minhas Ocorrências</h2>
                <button
                  onClick={() => setShowModal(true)}
